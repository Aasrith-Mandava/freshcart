...
{savings > 0 && (
            ...
            >
              {isPlacing ? (
                ...
                `Place Order — $${getTotalWithDelivery(total, tip, deliveryOption).toFixed(2)}`
              )}
            </button>
          </motion.div>
        </div>
  ...
  function getTotalWithDelivery(total, tip, deliveryOption) {
    return total + tip + (deliveryOption === 'express' ? EXPRESS_DELIVERY_FEE : 0)
  }